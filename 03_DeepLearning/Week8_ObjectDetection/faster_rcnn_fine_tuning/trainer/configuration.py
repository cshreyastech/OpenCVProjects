...
# base_dir = "../../../../data/Week8_ObjectDetection/Faster-RCNN-Fine-tuning-Experiment/"
@dataclass
class SystemConfig:
...
class DatasetConfig:
    ...
    # root_dir: str = os.path.join(base_dir, "data")
...
class DataloaderConfig:
    batch_size: int = 2 #250  # amount of data to pass through the network at each forward-backward iteration
