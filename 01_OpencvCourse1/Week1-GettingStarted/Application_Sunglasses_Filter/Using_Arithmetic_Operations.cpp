...
int main(void){
	...
	Mat glassMask1 = imread(RESULTS_PATH + "sunglassAlpha.png",0);
	Mat glassBGR = imread(RESULTS_PATH + "sunglassRGB.png");
	Mat glassMask;
	...
	imwrite(RESULTS_PATH + "maskedEyeRegion.png",maskedEye);
	imwrite(RESULTS_PATH + "maskedSunglassRegion.png",maskedGlass);
	imwrite(RESULTS_PATH + "augmentedEyeAndSunglass.png",eyeRoiFinal);
	...
	imwrite(RESULTS_PATH + "withSunglasses.png",faceWithGlassesArithmetic);
