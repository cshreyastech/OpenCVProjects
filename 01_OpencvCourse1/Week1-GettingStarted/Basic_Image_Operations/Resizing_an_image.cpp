...
int main(void){
	...
	imwrite(RESULTS_PATH + "resizedUp.png",resizedUp);
	imwrite(RESULTS_PATH + "resizedDown.png",resizedDown);
	...
	imwrite(RESULTS_PATH + "scaledUp.png", scaledUp);
	imwrite(RESULTS_PATH + "scaledDown.png", scaledDown);
