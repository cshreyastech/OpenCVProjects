...
int main(void){
	...
	imwrite(RESULTS_PATH + "sunglassRGB.png",glassBGR);
	imwrite(RESULTS_PATH + "sunglassAlpha.png",glassMask1);
	...
	imwrite(RESULTS_PATH + "glassMaskNOT.png",glassMaskNOT);
	...
	imwrite(RESULTS_PATH + "maskedEyeRegionBitwise.png",eye);
	imwrite(RESULTS_PATH + "maskedSunglassRegionBitwise.png",sunglass);
	imwrite(RESULTS_PATH + "augmentedEyeAndSunglassBitwise.png",eyeRoiFinal);
	...
	imwrite(RESULTS_PATH + "withSunglassesBitwise.png",faceWithGlassesBitwise);
